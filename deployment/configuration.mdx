---
title: "ORVIAN Environment Variables: Complete .env Reference"
sidebarTitle: "Configuration"
description: "Complete .env reference for ORVIAN: database, cache, queues, mail, third-party service APIs, and attendance notification thresholds."
---
