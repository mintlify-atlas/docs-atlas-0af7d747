...
description: "Set up Evolution API for WhatsApp alerts and Chatwoot for school messaging in ORVIAN. Configure environment variables and test the integrations."
---
...
<Steps>
  ...
  <Step title="Test the integration">
    ...
    Replace `1` with your actual school ID. The command clears the anti-spam cache for that school's students and immediately re-evaluates them, so alerts are dispatched even if they were already sent this week.
